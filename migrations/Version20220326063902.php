 ...
 */
final class Version20220326063902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('CREATE TABLE trip_info (id INT AUTO_INCREMENT NOT NULL, startcity VARCHAR(255) NOT NULL, endcity VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }

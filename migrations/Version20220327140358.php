 ...
 */
final class Version20220327140358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       /* $this->addSql('ALTER TABLE trip_info DROP FOREIGN KEY FK_E0B1A23C9597D27');
        ...
        $this->addSql('ALTER TABLE trip_info DROP tripid_id');*/
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        /*$this->addSql('ALTER TABLE trip_info ADD tripid_id INT NOT NULL, CHANGE startcity startcity VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE endcity endcity VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');

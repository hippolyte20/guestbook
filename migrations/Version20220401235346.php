 ...
 */
final class Version20220401235346 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP price, CHANGE transmean transmean VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');

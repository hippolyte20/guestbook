 ...
 */
final class Version20220401235739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, usere_id INT NOT NULL, lat DOUBLE PRECISION NOT NULL, lng DOUBLE PRECISION NOT NULL, lat2 DOUBLE PRECISION NOT NULL, lng2 DOUBLE PRECISION NOT NULL, transmean VARCHAR(255) NOT NULL, reserve_at DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_CBE5A33112C1BC7E (usere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A33112C1BC7E FOREIGN KEY (usere_id) REFERENCES user (id)');
    }

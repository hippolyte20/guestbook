 ...
 */
final class Version20220405195249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD numconducteur INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE book DROP numconducteur, CHANGE transmean transmean VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
